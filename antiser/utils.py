...
def get_daily_stations(station_code: str, variable: str):
    ...
    if 'PN' in station_code:
        ...
        daily_climatological_variables = antiser.climate.Climatology(observations).climatological_variables()
    else:
...
def get_reanalysis(variables, reanalysis_path, dates, lat, lon):
    ...
    if 'PCNR' in variables:
        ...
        relative_humidity = antiser.climate.Climatology(relative_humidity).climatological_variables()
        print(relative_humidity)
    ...
    if 'TMPA' in variables:
        ...
        temperature = antiser.climate.Climatology(temperature).climatological_variables()
